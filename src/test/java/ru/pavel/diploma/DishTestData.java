...
public class DishTestData {
    ...
    public static TestMatcher<Dish> DISH_MATCHER = TestMatcher.usingFieldsComparator();

    public static final int NOT_FOUND = 10;
    public static final int HAMBURGER_ID = START_SEQ+2;
    public static final int FRENCH_FRIES_ID = START_SEQ + 3;
    public static final int CHICKEN_SOUP_ID = START_SEQ + 4;
