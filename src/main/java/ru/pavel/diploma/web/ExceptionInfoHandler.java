...
import ru.pavel.diploma.util.ValidationUtil;
import ru.pavel.diploma.util.exception.ApplicationException;
import ru.pavel.diploma.util.exception.ErrorInfo;
import ru.pavel.diploma.util.exception.ErrorType;
import ru.pavel.diploma.util.exception.IllegalRequestDataException;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;

import static ru.pavel.diploma.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            ...
            "votes_unique_idx", EXCEPTION_DUPLICATE_DATETIME);
